# Source: https://medium.com/internet-of-technology/pascal-voc-xml-to-yolo-conversion-a-comprehensive-python-guide-eac3838d30bb
...
def main(input_dir: str, output_dir: str) -> None:
    ...
    # TODO: Currently hardcoded class mapping for classes that are completed, change to config when all classes are done
    # class_mapping = {name: idx for idx, name in enumerate(config["images"]["classes"])}
    class_mapping = {
        "30": 0,
        "40": 1,
        "50": 2,
    ...
    for xml_file in tqdm(os.listdir(input_dir), desc="Converting XML to YOLO format"):
